...
override {
        static_assert(std::is_base_of_v<IServiceInitializer, 
ServiceInitializer>,
                      "ServiceInitializer must be a descendant of 
IServiceInitializer");
        
static_assert(std::is_base_of_v<Poco::Net::HTTPRequestHandlerFactory, 
RequestHandlerFactory>,
                      "RequestHandlerFactory must be a descendant of 
